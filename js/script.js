...
document.getElementById("drink-btn").addEventListener("click", function () {
  ...
  showLoadingIcon(); // Make sure this function shows the loading icon

  setTimeout(() => {
    hideLoadingIcon(); // Ensure this function hides the loading icon
...
// Function to show the "Log Out" button when appropriate
...
// Add this code to your existing JavaScript (script.js) file
